...
class PermissionController extends Controller
{
    ...
    {
        try{
            $permissions = PermissionName::where('guard_name',PermissionName::$employee)->latest()->get();
    ...
    public function store(Request $request)
    {
        ...
        try{
        $perm = PermissionName::create(['permission_name'=>$request->permission,'guard_name'=>PermissionName::$employee]);
        // return $perm;
        if(isset($perm))
        {
